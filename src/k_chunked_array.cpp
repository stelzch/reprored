...
const int KChunkedArray::get_successor() const { return successor_rank; }
const bool KChunkedArray::has_no_k_intercept() const { return no_k_intercept; }
const vector<region> &KChunkedArray::get_k_chunks() const { return k_chunks; }
...
const uint64_t KChunkedArray::get_local_size() const { return size; }
const bool KChunkedArray::is_last_rank() const { return is_last_rank_flag; }
