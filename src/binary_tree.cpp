...
const uint64_t BinaryTree::get_starting_index() const { return begin; }
const uint64_t BinaryTree::get_end_index() const { return end; }
const uint64_t BinaryTree::get_global_size() const { return globalSize; }

const uint64_t BinaryTree::get_local_size() const { return size; }
